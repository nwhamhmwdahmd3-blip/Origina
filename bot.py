...
"""
🌿 Relax Manager – الملف الرئيسي (bot.py)
====================================================
- جميع الأوامر الأساسية والإشرافية والمتقدمة
- دعم كامل للعقوبات المخصصة (مخالفات)
- خطط الهدايا واشتراكات مجانية
- مهام خلفية متعددة (نشر تلقائي، نسخ احتياطي، تذكيرات، إنهاء العقوبات)
...
async def main():
    ...
    print("🔄 الإصدار: 4.0 (مع نظام العقوبات وخطط الهدايا)")
    ...
    # تحميل إعدادات الأزرار (بعد التأكد من وجود الدالة في utils.py)
    ...
    tasks = [
        ...
        asyncio.create_task(BackgroundTasks.expire_penalties_periodically()),
    ]
    ...
    if hostname:
        ...
        print("⚠️ استخدام Polling")
        await app.run_polling(drop_pending_updates=True)

    # عند الخروج، إلغاء المهام الخلفية
    for task in tasks:
        task.cancel()
