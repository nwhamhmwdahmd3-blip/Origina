# ===================================================================
# replies.py - ملف الردود التلقائية المدمجة
# ريلاكس مانيجر - النسخة الكاملة
# ===================================================================

"""
هذا الملف يحتوي على جميع الردود التلقائية المدمجة في البوت
يمكنك إضافة أو تعديل الردود كما تشاء
"""

import random
from typing import Union, List
# ===================================================================
# 1. ردود الترحيب (WELCOME REPLIES)
# ===================================================================
WELCOME_REPLIES = {
...
# ===================================================================
# 2. ردود الأسئلة الشائعة (FAQ REPLIES)
# ===================================================================
FAQ_REPLIES = {
...
# ===================================================================
# 3. ردود الشكر والإيجابية (POSITIVE REPLIES)
# ===================================================================
POSITIVE_REPLIES = {
...
# ===================================================================
# 4. ردود دينية (RELIGIOUS REPLIES)
# ===================================================================
RELIGIOUS_REPLIES = {
...
# ===================================================================
# 5. ردود النكات والدعابة (JOKE REPLIES)
# ===================================================================
JOKE_REPLIES = {
    "ضحك": ["😂😂", "ههههه 🤣", "ضحكتني 😂"],
...
# ===================================================================
# 6. ردود تحفيزية (MOTIVATIONAL REPLIES)
# ===================================================================
...
# ===================================================================
# 7. ردود اجتماعية (SOCIAL REPLIES)
# ===================================================================
SOCIAL_REPLIES = {
    ...
    "الاهل": ["الحمد لله، كلهم بخير 🌹", "الأهل في خير 🌸", "الله يحمي العائلة 🙏"],
...
# ===================================================================
# 9. ردود الطلبات (REQUEST REPLIES)
# ===================================================================
REQUEST_REPLIES = {
...
# ===================================================================
# 10. ردود عن البوت (ABOUT BOT REPLIES)
# ===================================================================
ABOUT_BOT_REPLIES = {
...
# ===================================================================
# 12. دمج جميع الردود في قاموس واحد
# ===================================================================
ALL_REPLIES = {}
...
# ===================================================================
# 13. دالة للحصول على رد عشوائي
# ===================================================================

def get_random_reply(keyword: str) -> str:
    """الحصول على رد عشوائي لكلمة معينة"""
    keyword = keyword.lower()
    if keyword in ALL_REPLIES:
        replies = ALL_REPLIES[keyword]
        if isinstance(replies, list):
            return random.choice(replies)
        return replies
    return None

def get_all_replies() -> dict:
    """إرجاع جميع الردود"""
    return ALL_REPLIES
