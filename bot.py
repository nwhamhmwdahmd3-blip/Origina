...
class UserState(Enum):
    ...
    WAITING_WARN_COUNT = auto()   # ✅ تمت إضافة هذا السطر
...
# يفترض وجود كلاس CallbackData معرف مسبقًا
...
async def _safe_answer(query, text, show_alert=False):
    ...
    try:
        ...
        logger.debug(f"تعذر إرسال query.answer: {e}")
