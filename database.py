...
class Database:
    ...
    async def register_user(self, user_id: int, username: str = "", first_name: str = "") -> bool:
        try:
            ...
            await self.execute(
                "INSERT INTO users (user_id, username, first_name, referral_code, created_at, updated_at) VALUES (?,?,?,?,?,?)",
    ...
    async def activate_trial(self, user_id: int) -> int:
        end_date = (TimeUtils.utc_now() + timedelta(days=3)).isoformat()
