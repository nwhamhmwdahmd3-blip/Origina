...
# =====================================================================
# 17. معالج الرسائل (مع دعم استيراد الملفات وGitHub والتصحيح)
# =====================================================================
class MessageHandlers:
    ...
    async def handle(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        # الحالة غير المعروفة - فقط في الخاص (لا تستدعي start في المجموعات)
        if update.effective_chat and update.effective_chat.type == 'private':
            await CommandHandlers.start(update, context)
        # إذا كانت مجموعة، لا تفعل شيئاً (تمت معالجة الردود أعلاه)
...
# =====================================================================
async def main():
    logger.info(f"🚀 Starting {CONFIG.BOT_NAME} v5.0.7-ultimate")
    await DB.initialize()
...
if __name__ == "__main__":
    print(f"🌿 {CONFIG.BOT_NAME} v5.0.7-ultimate - @RelaxMgr")
    print("✅ Ultimate Edition with GitHub import and group reply fix")
    try:
        asyncio.run(main())
    except KeyboardInterrupt:
        print("\n👋 تم الإيقاف")
