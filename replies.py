...
"""
replies.py - الردود التلقائية الثابتة (من الملف)
=================================================
يتم تحميل هذه الردود أولاً في المجموعات قبل البحث في قاعدة البيانات.
يمكنك تعديل هذا الملف وإضافة الردود التي تريدها.
